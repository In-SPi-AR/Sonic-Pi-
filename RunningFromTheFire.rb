...
dr1  = "/Users/ariffat/Documents/SonicPi_Samples/Groove 1 /" #add the path to your
#external sample directory... easiest way is to drag-n-drop the sample here and
#sonic pi will write the path for you eg "you path to the sample"
