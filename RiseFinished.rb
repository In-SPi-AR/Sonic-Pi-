...
play 28, release: 6, amp: 1, decay: 4
...
2.times do
  with_fx :ping_pong, phase: 1 do
    play 56, cutoff: 90, release: 12
  end
  sleep 8
end

sample :misc_crow, beat_stretch: 8, cutoff: 100
...
2.times do
  ...
  sample :arovane_beat_d, beat_stretch: 8, amp: 2
  ...
  with_fx :reverb, room: 1 do
    ...
    16.times do
      ...
      play 28, cutoff: 130, release: 0.1, amp: 1
      
      sleep 0.125
      
      play 28 + 12, cutoff: 80, release: 0.1, amp: 1
      
      sleep 0.125
      
      play 28 + 24, cutoff: 120, release: 0.1, amp: 1
      
      sleep 0.125
      
      play 28 + 36, cutoff: 80, release: 0.1, amp: 1
...
play 28, cutoff: 90, release: 6, amp: 1, attack: 8, decay: 16

#########################################################
use_synth :zawa
with_fx :panslicer,  phase: 0.5 do
  play 28, cutoff: 90, release: 6, amp: 1, attack: 16, sustain: 8, decay: 16
end
